...
router.post('/senator-data/create/', protectedKey, SenatorDataController.createSenatorData);
...
router.put('/senator-data/update/:id', protectedKey, SenatorDataController.updateSenatorData);

// DELETE: Delete senator data by ID
router.delete('/senator-data/delete/:id', protectedKey, SenatorDataController.deleteSenatorData);
